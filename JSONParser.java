...
public class JSONParser {
	...
	public LinkedList statusStack = new LinkedList();
	public LinkedList valueStack = new LinkedList();
	public Yylex lexer = new Yylex((Reader)null);
	public Yytoken token = null;
	public int status = S_INIT;
